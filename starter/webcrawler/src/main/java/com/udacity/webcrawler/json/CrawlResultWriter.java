...
public final class CrawlResultWriter {
  ...
  public void write(Path path) {
    ...
    try (Writer writer = new OutputStreamWriter(Files.newOutputStream(Objects.requireNonNull(path)))) { // "Files.ObjectOutputStream()" -> allows Serialized Data to be Written To File
