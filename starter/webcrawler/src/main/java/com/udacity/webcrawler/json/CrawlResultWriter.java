...
public final class CrawlResultWriter {
  ...
  public void write(Path path) {
    ...
    try (Writer writer = Files.newBufferedWriter(Objects.requireNonNull(path), StandardOpenOption.APPEND)) { // "Files.newBufferedWriter()" - creates writer (JSON string) from "Path" file
